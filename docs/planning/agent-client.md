...
- [[2026-04-19_2045_group-room-design|Group Room Design]] — complete group room design; client requirements include: CONCURRENT+GCD mode, digest batching with jitter, BATCH_CLOSED handling, attention modes (active/passive/muted), send-blocking enforcement, auto-mute escalation, per-room budget cap, CHECKPOINT integrity verification, and the six new MCP tools
