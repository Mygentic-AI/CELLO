...
- [[2026-04-15_1100_key-rotation-design|Key Rotation Design]] — establishes K_server as per-agent (not shared); independent K_local/K_server rotation; K_server_X rotation is directory-only; resolves Problem 9
- [[2026-04-17_1400_directory-relay-architecture-reassessment|Directory/Relay Architecture Reassessment]] — redraws the directory/relay boundary: directory as bookend authority (FROST at open and seal), relay as session-level Merkle engine; updates the Federated Node Model section
