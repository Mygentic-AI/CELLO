...
- [[2026-04-14_1300_connection-request-flow-and-trust-relay|Connection Request Flow — Trust Data Relay and Selective Disclosure]] — the connection request is the primary instance of the hash-verify-forward pattern: Alice sends trust data, directory verifies against hashes, forwards to Bob, then clears from memory
- [[2026-04-18_1454_merchant-crm-data-stash-and-free-samples|Merchant CRM Data Stash and Free Sample Tracking]] — the data stash follows the same client-as-custodian principle: merchant owns their own CRM data, directory never sees it
- [[2026-08-09_0436_sharing-a-sealed-conversation|Sharing a Sealed Conversation]] — applies this pattern to a whole transcript: the client holds the conversation, the directory holds the seal root and the counterparty's sharing grant, and the recipient verifies one against the other
