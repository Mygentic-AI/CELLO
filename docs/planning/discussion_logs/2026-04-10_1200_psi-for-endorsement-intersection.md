...
- [[2026-04-11_1400_security-architecture-layers-and-trust-signal-classes|Security Architecture Layers and Trust Signal Classes]] — PSI is identified as essential to preserving the relative (unexploitable) property of Class 2 network graph signals; the structural asymmetry analysis is the theoretical foundation for why PSI matters
- [[2026-04-14_1500_deprecate-trust-seeders-and-trustrank|Deprecate Trust Seeders and TrustRank]] — PSI and the Class 2 relative signal are identified as the hard Sybil defense that makes TrustRank (an absolute signal) unnecessary
- [[server-infrastructure|CELLO Server Infrastructure Requirements]] — G-18 deferred pending stack decision (Rust vs. Go); PSI is Phase 2; Phase 1 ships with direct comparison; library selection is specified as downstream of the stack choice
