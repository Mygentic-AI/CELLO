...
- [[cello-design|CELLO Design Document]] — Step 3 (directory authentication), Step 6 (session establishment, dual-path hash relay), Step 7 (Merkle tree, prev_root, CLOSE/CLOSE-ACK), Federation section (federated node model)
