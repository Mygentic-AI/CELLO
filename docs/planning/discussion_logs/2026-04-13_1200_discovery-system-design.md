...
- [[frontend|CELLO Frontend Requirements]] — discovery UI across all three classes (agent directory search, bulletin board listings, group room browser), incubation badge, and rate-limit display sourced from this log
