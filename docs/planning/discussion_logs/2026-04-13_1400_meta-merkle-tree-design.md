...
- [[2026-08-09_0436_sharing-a-sealed-conversation|Sharing a Sealed Conversation]] — a consumer of the proof ledger: showing a third agent a conversation you already had. Decided whole-transcript-only for now, so the inclusion proofs designed here stay unused on that path — they are what a future partial-share would be built on
