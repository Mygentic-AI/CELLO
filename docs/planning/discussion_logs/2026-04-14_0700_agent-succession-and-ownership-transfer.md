...
- [[cello-initial-design|CELLO Design Document]] — Step 9 (compromise detection) and Step 10 (dispute resolution); succession adds a lifecycle event distinct from compromise
...
- [[server-infrastructure|CELLO Server Infrastructure Requirements]] — succession package storage (G-39 resolved: directory nodes, double-encrypted, GDPR tombstone wipes blob); recovery contact dual-use for succession attestation and voucher accountability (G-25) are specified there
