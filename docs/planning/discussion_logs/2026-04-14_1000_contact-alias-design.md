...
- [[server-infrastructure|CELLO Server Infrastructure Requirements]] — alias creation rate limit (G-34: 1/week, 2nd allowed with unused slot), alias TTL mechanism (G-35: 6-month inactivity default, checkpoint-driven expiry), and the contact_aliases schema are specified there
