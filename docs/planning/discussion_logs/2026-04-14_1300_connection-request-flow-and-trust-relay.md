...
- [[server-infrastructure|CELLO Server Infrastructure Requirements]] — the directory's verify-then-relay-discard pattern for connection requests is specified there; incubation cap of 25/day (G-16) enforced by directory at FROST session establishment
