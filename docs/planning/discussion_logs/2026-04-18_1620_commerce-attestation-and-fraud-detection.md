...
- [[2026-05-08_1612_shared-state-as-protocol-primitive|Shared State as Protocol Primitive]] — shared workflows (Goal documents) tracking multi-phase transactions require purchase attestations for each phase handoff; CRDT operation logs complement attestations by recording state changes
