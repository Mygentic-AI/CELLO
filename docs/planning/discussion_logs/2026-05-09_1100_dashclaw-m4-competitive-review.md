...
- [[2026-05-28_1000_security-layer-v3-extensibility-and-split-gateway|Security Layer V3 — Extensibility, Hook Architecture, and Split Gateway]] — V3 resolves Gap 1 (block notifications now travel as hook notes to the agent) and Gap 2 (per-peer defense policy overrides designed as contact record field); observe mode implemented as async hooks
