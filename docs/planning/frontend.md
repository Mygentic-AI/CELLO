...
- [[2026-04-19_2045_group-room-design|Group Room Design]] — complete group room design; frontend requirements include: throttle manifest display, pre-join cost projection, room archetype presets, ownership transfer UI, dissolution UI, per-room budget dashboard with notification aggregation, DELIVERED/SEEN display states, violation/auto-mute indicators, and kick/ban management
