...
status: active
description: Capability-based milestone map (M0–M17) with libp2p peer-to-peer substrate from M0, implementation decisions, test harness evolution, and milestone-by-milestone user story indexes. Updated post-M8 to reflect Federation (M8B), Reactive Messaging (M8C), V3 security gateway (M9), Trust Signals (M10), shared CRDT state (M13), and revised dependency graph.
---
