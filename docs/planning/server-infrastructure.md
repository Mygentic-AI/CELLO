...
**[GAP G-44]**: Server-side mechanics and client-side state machine (AC-81, AC-82) are fully specified. Remaining open: portal succession claim contest UI (F-32), announcement period management UI (F-33), and new owner acceptance flow (F-34). These three portal screens are required before succession is implementable end-to-end.
...
| G-44 | Cross | Client-side (AC-81, AC-82) and server-side succession mechanics are resolved. Remaining open: portal succession claim contest UI (F-32), announcement period management UI (F-33), new owner acceptance flow (F-34). |
