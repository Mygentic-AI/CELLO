...
| M7-MANIFEST-002 — Client verification + polling | — | **merged to main** | Original m7/manifest-002 branch discarded (daemon scaffolding conflict); re-implemented as m7/manifest-002-fix in cello-client (daemon integration only); merged to main in both repos; 815+13 cello-client tests + 6 directory tests |
...
| M7-SIGNAL-001 — Signaling stream resilience | — | **implemented — PR ready** | Branch m7/signal-001 in cello-client; 30 tests (28 passed + 2 E2E skipped); stacked on m7/daemon-001; all reviewer findings fixed; version bump deferred (AC-014) |
