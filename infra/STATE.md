...
| @cello-protocol versions | **daemon 0.0.21 / cli 0.0.19 / connect 0.0.53** (+ crypto 0.0.14, transport 0.0.11, client 0.0.41, protocol-types 0.0.11) — updated 2026-07-02 ~14:30 UTC (M8B cascade 1, tag v0.0.62; was daemon 0.0.20/cli 0.0.18 earlier the same day) |
