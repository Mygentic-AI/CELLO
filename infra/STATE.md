...
| cello-cicd-dev | UPDATE_COMPLETE | 2026-06-06 | deploy.sh dev us-east-1 attempted 2026-07-19 to fix StagingDirectoryUrl — FAILED before reaching cicd stack. cello-ecs-directory-dev stack failed first: RegistryPathRule "One or more listeners not found". CFN stack still references old ALB 9f3cee2f6df31fc9 (physical resources) but live ALB is 61ee3093c761981a (cello-dir-dev-1341968405). Stack drift requires resource import or nuclear reset of cello-ecs-directory-dev in us-east-1 before deploy.sh can proceed. |
